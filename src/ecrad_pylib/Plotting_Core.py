...
#        yl = y_spl(np.linspace(0.0, 1.0, 4000))
        ...
        self.axlist[2].contour(EQSlice.R, EQSlice.z, EQSlice.rhop.T, \
        ...
        if(ray_deop_plot):
            ...
            self.axlist[2].contourf(EQSlice.R, EQSlice.z, Depo2D.T, cmap=plt.cm.get_cmap("Reds"), levels=np.linspace(0.05, 1.0, 11))
...
#         plt.clabel(CS2, inline=1, fontsize=12)
    ...
    def plot_ray(self, shot, time, ray, index=0, Eq_Slice=None, H=True, R_res=None, z_res=None, \
        ...
        if(equilibrium):
            ...
            z = Eq_Slice.z
            rhop = Eq_Slice.rhop
            self.axlist[0].contour(R, z, rhop.T, \
                                        levels=np.linspace(0.1, 1.2, 12), linewidths=1, colors="k", linestyles="--")
            self.axlist[0].contour(R, z, rhop.T, \
                levels=[1.0], linewidths=3, colors="b", linestyles="-")
...
#        yl = y_spl(np.linspace(0.0, 1.0, 4000))
    ...
    def E_field_plot(self, args):
        ...
        self.axlist[0].contour(R, z, Psi.T, \
             levels=Psi_grid)
