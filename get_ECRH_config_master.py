...
class gyrotron:
    def __init__(self, shot, N, ECS, ECN, view=False):  # N is the gyrotron number from 1-8
        ...
        if(N <= 4):
            if(shot < 33725):
                ...
                self.a = ECS.getParameter('P_sy{0:d}'.format(3) + '_g{0:d}'.format(N_2), 'GPolPos').data * 1000.0
